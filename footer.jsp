    ...
    <body >
        ...
        <div style="width:100% ; height:300px; background-color: black" >
            <div style="width:49%; height:280px; float:left">
                <p style="color:white;margin-top:25px;word-spacing:6px;letter-spacing:1.5px;font-size:15px; font-weight:lighter; font-family: serif ">© 2019 ABAP Insurance. ABAP trademark may be used only with permission from ABAP.
