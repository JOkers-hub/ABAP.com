...
<html>
    ...
    <body  style=" margin:0px;padding:0px;width:100% ;height:800px;background-color: whitesmoke ">
        <header>
    <jsp:include page="header.jsp"/>
      </header>
<div style="margin:5px 190px; width:70%; height:520px">
    ...
    <div style="width:100% ;height:400px; background-color:white">
        ...
        <a style="font-size:20px;color:blue;margin:6px;padding:5px"href="registrationform.jsp">Create an Account</a>
        </div>
    
      <div style="width:48%; height:400px; float:right">
