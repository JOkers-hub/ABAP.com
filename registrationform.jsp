...
<html>
    ...
    <body style="width:100% ;height:1000px">
        ...
        <form action="register.jsp" method="get">
                ...
                <div style="margin:5px 90px;border:2px solid brown; width:85%; height:700px">
          ...
          <div style=" width:100%;border:2px solid black;height:550px">
                <div style=" height:500px;width:50%; border:2px solid orange;float:left">
        ...
        <div style="float:right; width:48%;border:2px solid brown;height:500px">
            <image style="margin-top:150px" src="Registration1.jpg" width="90%" height="256px" />
        </div>
        </form>
        </div>
 </div>
            <div style="width:100%;clear:both; height:250px;border:2px solid blue">
